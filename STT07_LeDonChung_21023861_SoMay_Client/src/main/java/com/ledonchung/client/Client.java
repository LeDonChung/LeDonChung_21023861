...
import com.ledonchung.server.utils.RequestDTO;
import com.ledonchung.server.utils.ResponseDTO;

public class Client {
	private static final int PORT = 3861;
